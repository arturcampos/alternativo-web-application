...
@NamedQuery(name="Evento.findEventsByPersonIdAndDate", query="SELECT e FROM Evento e WHERE e.pessoa.id = :personId AND date_format(e.dataHoraEntrada, '%d/%m/%Y') = date_format(:date, '%d/%m/%Y') AND e.dataHoraSaida IS NULL")
})
