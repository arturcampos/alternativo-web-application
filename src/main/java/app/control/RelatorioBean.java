...
public class RelatorioBean implements Serializable {
	...
	/**
	 * Relat�rio de faltas cometidas por entrar no segundo hor�rio ou sair antes
	 * do hor�rio final
	 */
	public void relatorioFaltaHorarios() {
		...
		try {
			...
			report().setColumnTitleStyle(columnTitleStyle)
					...
					.title(// shows report title
					cmp.horizontalList()
						.add(	cmp.text("Faltas cometidas em rela��o aos Hor�rios Entrada/Sa�da").setStyle(titleStyle)
									.setHorizontalAlignment(HorizontalAlignment.LEFT),
								cmp.text("Futuro-Alternativo").setStyle(titleStyle)
									.setHorizontalAlignment(HorizontalAlignment.RIGHT))
						.newRow(2)
	...
	public void relatorioPresencaPorData(Date data) {
		...
		try {
			...
			report().setColumnTitleStyle(columnTitleStyle)
					...
					.title(// shows report title
					cmp.horizontalList()
						.add(	cmp.text("Lista de presença " + data).setStyle(titleStyle)
									.setHorizontalAlignment(HorizontalAlignment.LEFT),
								cmp.text("Futuro-Alternativo").setStyle(titleStyle)
									.setHorizontalAlignment(HorizontalAlignment.RIGHT))
						.newRow()
			...
			baos.toByteArray();
			res.setContentType("application/pdf");
			// C�digo abaixo gerar o relatório e disponibiliza diretamente na
			// p�gina
